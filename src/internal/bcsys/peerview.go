...
func (pv *peerView[LK, LV, LQ]) Endpoint(ctx context.Context) (blobcache.Endpoint, error) {
	return pv.svc.Endpoint(ctx)
}

func (pv *peerView[LK, LV, LQ]) Drop(ctx context.Context, h blobcache.Handle) error {
	return pv.svc.Drop(ctx, pv.incoming(h))
}

func (pv *peerView[LK, LV, LQ]) KeepAlive(ctx context.Context, hs []blobcache.Handle) error {
	return pv.svc.KeepAlive(ctx, slices2.Map(hs, pv.incoming))
}

func (pv *peerView[LK, LV, LQ]) InspectHandle(ctx context.Context, h blobcache.Handle) (*blobcache.HandleInfo, error) {
...
func (pv *peerView[LK, LV, LQ]) InspectVolume(ctx context.Context, h blobcache.Handle) (*blobcache.VolumeInfo, error) {
	return pv.svc.InspectVolume(ctx, pv.incoming(h))
}

func (pv *peerView[LK, LV, LQ]) OpenFiat(ctx context.Context, x blobcache.OID, mask blobcache.ActionSet) (*blobcache.Handle, error) {
	pol := pv.svc.env.Policy
...
func (pv *peerView[LK, LV, LQ]) OpenFrom(ctx context.Context, base blobcache.Handle, ltok blobcache.LinkToken, mask blobcache.ActionSet) (*blobcache.Handle, error) {
...
func (pv *peerView[LK, LV, LQ]) BeginTx(ctx context.Context, volh blobcache.Handle, txp blobcache.TxParams) (*blobcache.Handle, error) {
...
func (pv *peerView[LK, LV, LQ]) Commit(ctx context.Context, tx blobcache.Handle) error {
	return pv.svc.Commit(ctx, pv.incoming(tx))
}

func (pv *peerView[LK, LV, LQ]) Abort(ctx context.Context, tx blobcache.Handle) error {
...
func (pv *peerView[LK, LV, LQ]) Post(ctx context.Context, tx blobcache.Handle, data []byte, opts blobcache.PostOpts) (blobcache.CID, error) {
	return pv.svc.Post(ctx, pv.incoming(tx), data, opts)
}

func (pv *peerView[LK, LV, LQ]) Get(ctx context.Context, tx blobcache.Handle, cid blobcache.CID, buf []byte, opts blobcache.GetOpts) (int, error) {
...
func (pv *peerView[LK, LV, LQ]) Delete(ctx context.Context, tx blobcache.Handle, cids []blobcache.CID) error {
...
func (pv *peerView[LK, LV, LQ]) Visit(ctx context.Context, tx blobcache.Handle, cids []blobcache.CID) error {
...
func (pv *peerView[LK, LV, LQ]) Link(ctx context.Context, tx blobcache.Handle, target blobcache.Handle, mask blobcache.ActionSet) (*blobcache.LinkToken, error) {
	return pv.svc.Link(ctx, pv.incoming(tx), pv.incoming(target), mask)
}

func (pv *peerView[LK, LV, LQ]) Unlink(ctx context.Context, tx blobcache.Handle, ltoks []blobcache.LinkToken) error {
	return pv.svc.Unlink(ctx, pv.incoming(tx), ltoks)
}

func (pv *peerView[LK, LV, LQ]) VisitLinks(ctx context.Context, tx blobcache.Handle, targets []blobcache.LinkToken) error {
	return pv.svc.VisitLinks(ctx, pv.incoming(tx), targets)
}

func (pv *peerView[LK, LV, LQ]) CreateQueue(ctx context.Context, host *blobcache.Endpoint, qspec blobcache.QueueSpec) (*blobcache.Handle, error) {
	if host != nil {
...
func (pv *peerView[LK, LV, LQ]) InspectQueue(ctx context.Context, q blobcache.Handle) (blobcache.QueueInfo, error) {
	return pv.svc.InspectQueue(ctx, pv.incoming(q))
}

func (pv *peerView[LK, LV, LQ]) Dequeue(ctx context.Context, q blobcache.Handle, buf []blobcache.Message, opts blobcache.DequeueOpts) (int, error) {
	return pv.svc.Dequeue(ctx, pv.incoming(q), buf, opts)
}

func (pv *peerView[LK, LV, LQ]) Enqueue(ctx context.Context, q blobcache.Handle, msgs []blobcache.Message) (*blobcache.InsertResp, error) {
	return pv.svc.Enqueue(ctx, pv.incoming(q), msgs)
}

func (pv *peerView[LK, LV, LQ]) SubToVolume(ctx context.Context, q blobcache.Handle, vol blobcache.Handle, spec blobcache.VolSubSpec) error {
...
func (pv *peerView[LK, LV, LQ]) outgoing(x blobcache.Handle) blobcache.Handle {
...
func (pv *peerView[LK, LV, LQ]) incoming(x blobcache.Handle) blobcache.Handle {
	key := derivePeerSecret(pv.tmpSecret, pv.peer)
	ciph, err := aes.NewCipher(key[:])
	if err != nil {
		panic(err)
