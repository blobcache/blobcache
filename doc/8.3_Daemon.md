...
## `blobcache daemon --state <dir> [--serve-api proto://addr] [--net host:port]`
...
- `--serve-api <proto://addr>` Optional listener for the HTTP API.
...
## `blobcache daemon-ephemeral [--serve-api proto://addr] [--net host:port]`
