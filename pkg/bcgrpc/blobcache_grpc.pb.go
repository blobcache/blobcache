...
func (c *blobcacheClient) ListEntries(ctx context.Context, in *ListEntriesReq, opts ...grpc.CallOption) (Blobcache_ListEntriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Blobcache_serviceDesc.Streams[0], "/blobcache.Blobcache/ListEntries", opts...)
	if err != nil {
		return nil, err
	}
...
func RegisterBlobcacheServer(s *grpc.Server, srv BlobcacheServer) {
